...
Build secure admin tooling for job counts, ingestion runs, source health, API usage, JSA imports, failures, duplicate groups and data freshness. Protect all admin routes. Provide safe retry/reprocess actions where appropriate. Avoid destructive actions without confirmation/audit logging. Add operational tests.
