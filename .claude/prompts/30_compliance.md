# Prompt 30 — Data Compliance Gate
...
Perform a source-by-source compliance review. Document API/feed terms, commercial use, display/redistribution, caching, retention, deletion, attribution, branding, application links and rate limits. Do not infer permission. Flag blockers requiring provider agreement. Create docs/data-sources.md and docs/compliance.md. This milestone is a gate before commercial launch.
