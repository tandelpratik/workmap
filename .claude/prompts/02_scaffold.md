...
Implement the approved foundation. Set up Next.js, TypeScript, Tailwind, PostgreSQL, Prisma, Zod, testing, linting, formatting, environment validation, error conventions and documentation. Create brand configuration. Establish directories and import boundaries. Add health endpoint and basic observability hooks. Do not add product features. Run all checks.
