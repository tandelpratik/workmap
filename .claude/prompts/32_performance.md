# Prompt 32 — Performance Engineering
...
Profile database, search, heatmap aggregation, ingestion, map rendering and frontend loading. Add indexes, query optimization, caching and geometry simplification where justified. Establish target budgets and measure them. Do not add Redis/search clusters until profiling demonstrates need. Document bottlenecks and decisions.
