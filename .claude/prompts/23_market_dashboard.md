...
Build the main market intelligence experience. Make the heatmap primary. Include market summary, trend, top locations, occupation context, skill demand and salary insight without turning the page into a grid of cards. Use editorial hierarchy and restrained visualization. Ensure every metric identifies source, period and units.
