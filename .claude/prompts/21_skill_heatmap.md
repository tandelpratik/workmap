# Prompt 21 — Skill Geography Heatmap
...
Build skill × geography heatmaps from individual listings. Example: percentage of Business Analyst listings mentioning SQL by state. Support occupation, skill, geography and period. Clearly identify source as platform-derived job-listing data. Handle small samples and missing data. Reuse the geographic visualization system.
