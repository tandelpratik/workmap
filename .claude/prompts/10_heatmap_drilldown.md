# Prompt 10 — Geographic Drilldown
...
Implement Australia → state/territory → supported regional level. Preserve occupation, metric and period filters. Add breadcrumbs, back navigation, selected-region details, rankings where valid and source context. Prevent unsupported drilldowns. Handle geometry/data mismatch gracefully. Add navigation and API integration tests.
