# Prompt 11 — Occupation Intelligence
...
Build occupation profiles using ANZSCO/JSA-supported mappings. Show national/state/regional demand, historical trend, top regions, growth and metadata. Link directly into filtered heatmap and job search. Distinguish official JSA metrics from platform-derived listing metrics. Add SEO-friendly routing without mass-generating low-value pages.
