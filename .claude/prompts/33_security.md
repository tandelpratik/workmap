...
Perform a production security review. Cover secrets, provider credentials, authentication/authorization where implemented, input validation, SQL injection, XSS, CSRF, SSRF risk, admin endpoints, rate limiting, dependency vulnerabilities, logging and data exposure. Fix high/critical findings and document residual risk.
