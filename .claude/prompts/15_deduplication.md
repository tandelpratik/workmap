# Prompt 15 — Deduplication & Canonicalization
...
Implement duplicate detection across permitted sources. Use sourceJobId and canonical URL first, then normalized company/title/location and description similarity. Produce a confidence score. Automatically merge only high-confidence matches; preserve source records and relationships. Create canonical job identity and duplicate groups. Add false-positive/false-negative fixtures and review tooling.
