...
Make provenance first-class. Every job and market metric must expose source, identifier/dataset, reference period, import timestamp, version and methodology where relevant. Build reusable source badges and methodology panels. Ensure exports/API responses preserve provenance. Add automated tests that reject records without required provenance.
