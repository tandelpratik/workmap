...
Build the flagship map. Use authoritative geometry, sequential quantitative colour scale, legend, selection, details, drilldown affordance, loading/error/empty states and source/methodology labels. Do not use generic card-heavy SaaS design. Provide accessible table alternative. Ensure tap/click selection persists. Keep map payloads performant. Test responsive layout and accessibility.
