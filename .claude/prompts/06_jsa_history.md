# Prompt 06 — Historical JSA Series
...
Add historical monthly IVI support where available. Preserve observations by reference period and dataset version. Implement time-series repository/API queries, missing-period handling and validation. Prevent silent overwrites. Add tests for ordering, duplicate periods, versioning and gaps. Document coverage limits.
