...
Implement technical SEO for valuable occupation, location and job pages. Add metadata, canonical URLs, sitemap, robots, structured data where valid, internal linking and expiry handling. Avoid thin/faceted page explosions. Define indexing rules for expired/duplicate jobs. Test generated metadata and canonical behavior.
