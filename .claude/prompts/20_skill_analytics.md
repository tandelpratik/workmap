...
Build occupation skill-frequency, percentage, trend and matrix analytics from stored listings. Define denominators explicitly. Support sample-size display and insufficient-data states. Clearly label these as platform-derived. Provide APIs and UI data contracts. Add tests for denominator correctness and sparse data.
