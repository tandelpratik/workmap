# Prompt 18 — Jobs ↔ Market Experience
...
Connect job discovery to market intelligence. For an occupation/search, expose Jobs, Market Demand and Locations views while preserving relevant filters. Add 'Explore demand' actions from job search and 'View jobs' from heatmap/occupation pages. Ensure official JSA metrics and individual listings remain visually and semantically distinct.
