# Prompt 25 — Free-Tier Optimization
...
Audit API usage, database queries, ingestion frequency, geometry payloads and frontend performance. Implement permitted caching, deduplicated requests, scheduled batch ingestion and usage tracking. Create an internal usage dashboard. Do not add paid infrastructure. Document hard limits and graceful degradation when limits are reached.
