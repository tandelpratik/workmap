# Prompt 34 — Production Deployment
...
Prepare deployment with environment separation, controlled database migrations, health checks, structured logs, scheduled ingestion, error handling, backups/recovery documentation and rollback procedure. Document free-tier limits and failure modes. Ensure secrets are managed correctly and production data is not seeded with fake fixtures.
