...
Implement production-oriented schema for Job, Company, Location, JobSource, Skill, JobSkill, Occupation, Geography, IngestionRun, IngestionError, JobDuplicateGroup, LabourMarketMetric, LabourMarketSeries and GeographyMetric. Add source identifiers, provenance, timestamps, status, salary, remote/employment fields and appropriate indexes/constraints. Design for idempotent ingestion and future multi-source scale. Generate migrations, seed fixtures and database tests.
