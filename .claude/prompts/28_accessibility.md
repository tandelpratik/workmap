...
Perform and fix an accessibility audit across search, heatmaps, tables, controls, job pages and navigation. Ensure keyboard operation, visible focus, semantic labels, contrast, colour-independent meaning and mobile usability. Heatmap must have equivalent accessible table/list. Add automated checks plus manual test documentation.
