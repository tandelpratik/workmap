...
Implement search with keyword, title, company, occupation, geography, salary, employment type, remote type, skills and date filters. Support relevance, newest and salary sorting. Use PostgreSQL initially. Add cursor/offset strategy appropriate to scale, validation, pagination, stable ordering, indexes and tests. Return source/freshness context.
