# Prompt 01 — Product & Architecture
...
Define the production architecture before coding. Read all root docs. Inspect repo. Produce architecture decision record covering domain boundaries, source adapters, JSA/individual-job separation, geospatial pipeline, analytics, search, observability, deployment and future commercial scaling. Treat WorkMap as replaceable branding. Do not implement yet. Acceptance: architecture is provider-neutral, heatmap-first, free-tier viable and commercial-upgradable.
