...
Implement normalization for titles, company names, Australian locations, state/territory, employment type, remote type and salary. Preserve original values. Normalize common variants consistently. Build reusable functions with explicit types and confidence/status where ambiguity exists. Add comprehensive fixtures and tests. Do not discard source information.
