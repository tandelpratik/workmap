# Prompt 04 — Geographic Foundation
...
Implement authoritative Australian geography ingestion. Support country, state/territory, SA4 and IVI region where source data supports them. Store official IDs, names, parent hierarchy, geometry, source and version. Validate topology/relationships. Separate source geometry from display geometry so simplification is reversible. Do not invent boundaries. Add importer, repository, fixtures and tests.
