  ...
  return (
    <>
      ...
      <main id="main" className="mx-auto max-w-3xl px-6 py-14 sm:py-20">
        <header>
          <h1 className="text-ink font-serif text-4xl leading-tight font-semibold sm:text-5xl">
        ...
        */}
          ...
          <p className="text-ink-faint max-w-measure mt-4 text-sm leading-relaxed">
            ...
            advertised online, not a count of all vacancies in Australia. Salaries marked
            as an Adzuna Jobsworth estimate were predicted by Adzuna, not quoted by the
            employer.
          </p>
        </footer>
      </main>
